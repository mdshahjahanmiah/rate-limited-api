...
Rate-limited API is an **Agoda's** rate limiting solution and that can use for any parties, For example hotel management system, and designed to control the rate of requests that clients can make to a Web API.
